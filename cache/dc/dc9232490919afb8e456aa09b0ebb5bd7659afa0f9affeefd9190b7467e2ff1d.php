...
class __TwigTemplate_db2c967a6688fd18d4ba6da7544d7cc9eb18dcf55222ca3ad9791205d41445de extends Twig_Template
{
                ...
                <form action=\"{{ path_for('HR.NewApplicant') }}\" method=\"post\" autocomplete=\"on\" enctype=\"multipart/form-data\" >
                    ...
                    <div class=\"form-group has-feedback{{ errors.dob ? ' has-error' : '' }}\">
                            ...
                            <div class=\"input-group date\">
                                ...
                                <input type=\"text\" class=\"form-control pull-right\" name=\"dob\" id=\"datepicker\" value=\"{{ old.dob ? old.dob : '1984-09-03' }}\">
                            </div>
                            {% if errors.dob %}
