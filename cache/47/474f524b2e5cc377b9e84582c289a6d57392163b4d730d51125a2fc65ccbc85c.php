...
class __TwigTemplate_e9fcc995a025c69adb5e420efa48555ee5812885345dbbca6300956de699b7a9 extends Twig_Template
{
    ...
    <section class=\"content\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["applicant"]) {
            ...
            echo "</td>
                        <td>";
            // line 47
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->getSourceContext(), $context["applicant"], "txtNationality", array(), "method"), "html", null, true);
            echo "</td>
                        <td>";
            // line 48
            ...
            <table class=\"table table-responsive table-striped table-hover table-condensed\">
                ...
                {% for applicant in HR.applicants %}
                    <tr>
                        ...
                        <td>{{ applicant.txtNationality() }}</td>
