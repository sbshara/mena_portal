...
/* auth/Operations/TMS/Dashboard.twig */
class __TwigTemplate_0b2f67096d2a15c38ffdcc90f344d28749f83c6f431a14d4e531670e8723870b extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("templates/app.twig", "auth/Operations/TMS/Dashboard.twig", 1);
        $this->blocks = array(
    ...
    <section class=\"content\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["vehicle"]) {
            ...
            // line 20
            echo twig_escape_filter($this->env, $this->env->getExtension('Slim\Views\TwigExtension')->pathFor("OPS.Assets.TruckById", array("id" => twig_get_attribute($this->env, $this->getSourceContext(), $context["vehicle"], "id", array()))), "html", null, true);
            echo "\"> ";
...
";
    ...
    {
        return "auth/Operations/TMS/Dashboard.twig";
    }
        ...
        <div class=\"row\">
            <div class=\"col-md-12\">
                {% for vehicle in OPS.Vehicles %}
                    <div class=\"box\">
                        <div class=\"box-header with-border\">
                            <h3 class=\"box-title\"><a class=\"fa fa-truck\" href=\"{{ path_for('OPS.Assets.TruckById', {id: vehicle.id}) }}\"> {{ vehicle.nickName() }}</a> <small> (VIN: {{ vehicle.vin | e }})</small></h3>
                        </div>
                        <div class=\"box-body\">
                            <div class=\"row\">
                                <p class=\"text-center\">
...
{% endblock %}
", "auth/Operations/TMS/Dashboard.twig", "/Users/shiblie/Sites/mena_portal/resources/views/auth/Operations/TMS/Dashboard.twig");
    }
}
